...
for r in {1..5}; do
  ...
  for i in {1..10}; do
    ...
    python3 ./network_init/network_init.py "$i" 100000 LoRaWAn 1
    cd cmake-build-debug || return
    ./Lora_sim_cpp
    cd ..

    python3 ./network_init/network_init.py "$i" 100000 LoRaWAn 2
    cd cmake-build-debug || return
    ./Lora_sim_cpp
    cd ..

    python3 ./network_init/network_init.py "$i" 100000 LoRaWAn 3
    cd cmake-build-debug || return
    ./Lora_sim_cpp
    cd ..
