...
echo "case,rate,decoded,non_decoded,nodes_number,life_time,maximum_trans,gen_packets,delay,max_delay,interference_in_node,out_of_range_in_ge,in_range_in_ge,mean_sf" > results/metrics.txt
for r in {1..10}; do
  echo ""
  nodes_num=$((25 * r))
